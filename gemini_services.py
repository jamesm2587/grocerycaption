...
IMAGE_ANALYSIS_PROMPT_TEMPLATE = (
    ...
    "Store Name: [Use visual logos as the primary clue. If you see a prominent logo (like a large letter 'R'), you MUST prioritize identifying a store with that letter (e.g., 'RRanch Market'), even if the full text is not perfectly clear. Extract the most likely store name based on this rule.]\n"
